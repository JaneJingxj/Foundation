...
public class RoundProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mMode == STROKE_TEXT) {
            ...
            float textHalfWidth = mPaint.measureText(percent + getContext().getString(R.string.percent))*0.5f;
            canvas.drawText(percent + getContext().getString(R.string.percent), center - textHalfWidth, center +textHalfSize,
                    mPaint);
        }
